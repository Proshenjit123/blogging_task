...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('admin/assets/imgs/theme/logo.svg') }}" />
    <!-- Template CSS -->
    ...
    <aside class="navbar-aside" id="offcanvas_aside">
        ...
        <nav>
            <ul class="menu-aside">
                ...
                <!-- Other menu items -->
                <li class="menu-item {{ Request::route()->getName() == 'post.index' ? 'active' : '' }}">
                ...
                {{-- <li class="menu-item has-submenu">
                    ...
                    <div class="submenu">
                        <a href="page-products-list.html">Ecommerce & APP</a>
                        <a href="page-products-grid.html">EduTech & Accounting</a>
                        <a href="page-products-grid-2.html">ERP Software</a>
                        <a href="page-categories.html">POS Software</a>
                        <a href="page-categories.html">Pharmacy Software</a>
                        <a href="page-categories.html">Fashion and Footware</a>
                        <a href="page-categories.html">Export And import Bussiness</a>
                        <a href="page-categories.html">Fashion and Footware</a>
                    </div>
                </li>
                <li class="menu-item has-submenu">
                    ...
                    <div class="submenu">
                        <a href="page-orders-1.html">About us</a>
                        <a href="page-orders-2.html">Advisor</a>
                        <a href="page-orders-detail.html">Blogs</a>
                        <a href="page-orders-detail.html">FAQ</a>
                    </div>
                </li>
                <li class="menu-item has-submenu">
                    ...
                    <div class="submenu">
                        <a href="page-sellers-cards.html">Web Development</a>
                        <a href="page-sellers-list.html">Mobile App Develop</a>
                        <a href="page-seller-detail.html">Management Software</a>
                        <a href="page-seller-detail.html">AI & Automation</a>
                        <a href="page-seller-detail.html">AWS Services</a>
                        <a href="page-seller-detail.html">It Infrastructure</a>
                    </div>
                </li>
                <li class="menu-item">
                ...
                <li class="menu-item {{ Request::route()->getName() == 'comments.index' ? 'active' : '' }}">
                    ...
                    <li class="dropdown nav-item">
                        <a class="dropdown-toggle" data-bs-toggle="dropdown" href="#" id="dropdownAccount" aria-expanded="false">
                            @if(auth()->user()->profile_picture)
                                <img class="img-xs rounded-circle" src="{{ asset(auth()->user()->profile_picture) }}" alt="User" />
                            @else
                                <img class="img-xs rounded-circle" src="{{asset('admin/assets/imgs/people/avatar-4.png')}}" alt="Default User" />
                            @endif
                        </a>
